  ...
  const secoes = [
    {
      ...
      description:
        "Na H2B Plásticos, valorizamos sua privacidade e estamos comprometidos em proteger seus dados pessoais. Coletamos informações que você nos fornece diretamente, como:",
      items: [
    ...
    },
    {
      ...
      description:
        "Não vendemos, trocamos ou transferimos suas informações pessoais para terceiros sem seu consentimento, exceto quando necessário para operar nosso site, conduzir nossos negócios ou cumprir a lei.",
      items: [
    ...
    },
    {
      ...
      description:
        "Se tiver dúvidas sobre esta Política de Privacidade ou sobre como tratamos seus dados, entre em contato com nosso Encarregado de Dados (DPO):",
      items: [
          ...
          <div className="relative mb-12">
            ...
            <div className="text-center mb-12">
              ...
              <motion.p
                ...
                variants={fadeUp}
              >
                Sua privacidade é nossa prioridade. Saiba como protegemos seus
                dados pessoais
              </motion.p>
            </div>
                      ...
                      {secao.id === "contato" && (
                        <div className="mt-4 p-4 bg-white/5 rounded-lg border border-white/10">
                          ...
                          <p className="text-gray-300 text-sm">
                            Nosso DPO está disponível para esclarecer dúvidas
          ...
          >
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-gray-300 text-sm">
                  A H2B Plásticos está totalmente em conformidade com a Lei
                  Geral de Proteção de Dados, garantindo que seus dados sejam
                  tratados com transparência, segurança e respeito aos seus
                  direitos fundamentais de privacidade.
                </p>
              </div>
            </div>
          </motion.div>
