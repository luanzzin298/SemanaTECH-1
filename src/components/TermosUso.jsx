  ...
  const secoes = [
    {
      ...
      content:
        "Ao acessar e usar o site da H2B Plásticos, você concorda em cumprir estes Termos de Uso e todas as leis e regulamentos aplicáveis. Se você não concordar com algum destes termos, está proibido de usar ou acessar este site.",
    },
    {
      id: "licenca",
      icon: FaDatabase,
      ...
      content:
        "É concedida permissão para baixar temporariamente uma cópia dos materiais no site da H2B Plásticos apenas para visualização transitória pessoal e não comercial. Esta é a concessão de uma licença, não uma transferência de título.",
      restrictions: [
    ...
    },
    {
      ...
      content:
        'Os materiais no site da H2B Plásticos são fornecidos "como estão". A H2B Plásticos não oferece garantias, expressas ou implícitas, e por meio deste nega e anula todas as outras garantias, incluindo, sem limitação, garantias implícitas ou condições de comercialização, adequação a um fim específico ou não violação de propriedade intelectual.',
    },
    {
      id: "limitacoes",
      ...
      title: "4. Limitações",
      content:
        "Em nenhum caso a H2B Plásticos ou seus fornecedores serão responsáveis por quaisquer danos (incluindo, sem limitação, danos por perda de dados ou lucro ou devido a interrupção dos negócios) decorrentes do uso ou da incapacidade de usar os materiais em seu site.",
    },
    {
      id: "alteracoes",
      icon: FaRegClock,
      ...
      content:
        "A H2B Plásticos pode revisar estes Termos de Uso a qualquer momento, sem aviso prévio. Ao usar este site, você concorda em ficar vinculado à versão atual destes Termos de Uso.",
    },
    {
      id: "lei",
      icon: FaBalanceScale,
          ...
          <div className="relative mb-12">
            ...
            <div className="text-center mb-12">
              ...
              <motion.p
                ...
                variants={fadeUp}
              >
                Leia atentamente nossos termos e condições antes de utilizar
                nossos serviços
              </motion.p>
            </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-gray-300 text-sm">
                  Ao continuar utilizando nosso site, você declara ter lido,
                  entendido e concordado com todos os termos e condições
                  estabelecidos neste documento. Recomendamos revisar
                  periodicamente esta página para estar ciente de eventuais
                  alterações.
                </p>
              </div>
            </div>
